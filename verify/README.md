...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-ads-js` (+ `@particle-academy/google-ads-ui`, resolved transitively) |
...
npm install @particle-academy/google-ads-js @particle-academy/fancy-flow
