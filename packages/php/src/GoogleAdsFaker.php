 ...
 */
/**
 * The Google Ads faker — the PHP twin of the js package's `src/faker.ts`.
 *
...
final class GoogleAdsFaker
{
    ...
    public static function respond(string $operation, array $request): mixed
    {
        ...
        return match ($operation) {
            'customer_list_accessible' => self::CustomerListAccessible($config, $fake),
