 ...
 */
/**
 * Every Google Ads node executor — the PHP twin of `GOOGLE_ADS_RUNNABLE_KINDS`
 * in @particle-academy/google-ads-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GoogleAdsFlow::register($kinds, $executors)` — one call, no directory
 * scan.
 ...
 */
final class GoogleAdsFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        CustomerListExecutor::class,
    ];
